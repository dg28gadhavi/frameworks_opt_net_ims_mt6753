...
public class ImsManager {
     ...
     */
    public static boolean isVtSettingEnabledByUser(Context context) {
    ...
    public static void setVtSetting(Context context, boolean enabled) {
        ...
        if (imsManager != null) {
            try {
                ...
                config.setFeatureValue(ImsConfig.FeatureConstants.FEATURE_TYPE_VIDEO_OVER_WIFI,
    ...
    public void setCallIndication(int serviceId, Intent incomingCallIndication,
        ...
        try {
            mImsService.setCallIndication(callId, callNum, seqNum, isAllow);
        } catch (RemoteException e) {
