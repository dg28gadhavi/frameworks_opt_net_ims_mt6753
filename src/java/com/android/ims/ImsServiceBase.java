...
public abstract class ImsServiceBase {
    ...
    private final class ImsServiceBinder extends IImsService.Stub {
        ...
        public void setCallIndication(String callId, String callNum, int seqNum, boolean isAllow) {
            onSetCallIndication(callId, callNum, seqNum, isAllow);
        }
    ...
    protected void onSetCallIndication(String callId, String callNum, int seqNum, boolean isAllow) {
        // no-op
    }
    ...
    protected int onGetRegistrationStatus() {
        ...
        return 100; //Code for WFC OFF and default errors, if any
    }
}
